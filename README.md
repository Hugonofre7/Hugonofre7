...
Lidero el diseño e implementación de un sistema de monitoreo en tiempo real para malaria, basado en una arquitectura geoespacial con MySQL y servicios de localización. El sistema integra datos epidemiológicos con coordenadas de campo, permitiendo análisis de conglomerados y alertas tempranas.  
*Impacto:* +30% en capacidad de respuesta operativa en regiones de alta incidencia.
...
- **Slab Allocator en C++**  
  ...
  [Repositorio](https://github.com/Hugonofre7/slab-allocator) — *Pruebas de rendimiento vs. malloc.*

- **Linux Toolkits**  
  Conjunto de utilidades en Bash y C++ para administración de sistemas: monitoreo de procesos, gestión de logs y automatización de provisioning en servidores Ubuntu.  
  [Repositorio](https://github.com/Hugonofre7/linux-toolkits)
